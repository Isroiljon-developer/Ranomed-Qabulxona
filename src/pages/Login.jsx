  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (role !== 'admin' && role !== 'reception') {
        setError("Bu panel faqat Qabulxona uchun! Siz " + role + " rolidagilar uchun boshqa panelga kirishingiz kerak.");
        setLoading(false);
        return;
      }
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 460 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.8)', marginTop: 6, fontSize: 16, fontWeight: 500 }}>Qabulxona paneli</p>
        </div>
        ...
        <div style={{ background: 'white', borderRadius: 24, padding: 40, boxShadow: '0 25px 80px rgba(0,0,0,0.2)' }}>
          ...
          <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid #f1f5f9' }}>
            ...
            >
              <div>
                <p style={{ fontSize: 12, color: '#64748b', margin: 0, marginBottom: 2 }}>Qabulxona uchun:</p>
                <p style={{ fontSize: 14, fontWeight: 600, color: '#0f172a', margin: 0 }}>Login: <span style={{ color: '#3b82f6', fontFamily: 'monospace' }}>reception</span></p>
              </div>
              <div style={{ textAlign: 'right' }}>
                <span style={{ fontSize: 12, color: '#64748b', display: 'block', marginBottom: 2 }}>Parol:</span>
                <span style={{ fontSize: 12, fontFamily: 'monospace', fontWeight: 700, background: '#e2e8f0', color: '#374151', padding: '2px 8px', borderRadius: 6 }}>reception123</span>
              </div>
            </div>
